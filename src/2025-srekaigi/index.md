...
## →SREのリーダー的なことをやっていれば、スタッフエンジニアになるのでは？

---

# SREのスタッフエンジニアのタイプ

テックリードに加えてアーキテクトの要素が
SREのスタッフエンジニアには期待される
...
スタッフエンジニアは、SREとして取り組む課題を共有したり組織を巻き込んでプロジェクトを進めるために、他のチームやステークホルダー、経営層とのコミュニケーションを行う
---
...
を通してチームメンバーを育成し、自分がいなくても回るチームを作る
